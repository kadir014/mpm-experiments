 ...
 * @return nvVector2 
 */
static inline nvVector2 nvVector2_mul(nvVector2 v, float s) {
 ...
 * @return nvVector2 
 */
static inline nvVector2 nvVector2_div(nvVector2 v, float s) {
    return NV_VECTOR2(v.x / s, v.y / s);
}
 ...
 * @return float 
 */
static inline float nvVector2_len2(nvVector2 v) {
 ...
 * @return float
 */
static inline float nvVector2_dot(nvVector2 a, nvVector2 b) {
    return a.x * b.x + a.y * b.y;
}
 ...
 * @return float 
 */
static inline float nvVector2_cross(nvVector2 a, nvVector2 b) {
 ...
 * @return float 
 */
static inline float nvVector2_dist2(nvVector2 a, nvVector2 b) {
 ...
 * @return nvVector2 
 */
static inline nvVector2 nvVector2_lerp(nvVector2 a, nvVector2 b, float t) {
